    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.enviar:
                ...
                break;
            case R.id.ver:
                Intent it3=new Intent(Intent.ACTION_VIEW, Uri.parse("http://nuevo.rnrsiilge-org.mx/baraja/resultados"));
                startActivity(it3);
                Toast.makeText(getApplicationContext(),"SUERTE CHAVALON",Toast.LENGTH_LONG).show();
                break;
